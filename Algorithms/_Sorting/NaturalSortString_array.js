...
// Естественная сортировка (англ. Natural sort) — 
// простая и эффективная модификация сортировки слиянием,
//  которая учитывает, что данные (или их часть)
//   могут быть уже отсортированы. Суть её в том, 
//   что нужно образовывать цепочки, и производить 
//   их слияние не в заранее определённом и фиксированном порядке,
